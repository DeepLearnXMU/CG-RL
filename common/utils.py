...
def init_arg_parser():
    ...
    arg_parser.add_argument('--shuffle_mode', default='normal', choices=['save', 'normal', 'random', 'reverse'], help='shuffle mode')
    arg_parser.add_argument('--seed', default=0, type=int, help='Random seed')
    arg_parser.add_argument('--lamda', default=0, type=float, help='lambda')
    arg_parser.add_argument('--epsilon', default=0, type=float, help='epsilon for random sampling')
    arg_parser.add_argument('--weight_decay', default=0, type=float, help='L2 normalization for selector module')
    ...
    arg_parser.add_argument('--mode', choices=['train', 'test', 'pretrain', 'train_rl'], required=True, help='Run mode')
