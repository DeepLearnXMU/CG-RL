...
class Hypothesis(object):
    ...
    def clone_and_apply_action(self, action, shuffle_fields_idx=None):
        new_hyp = self.copy()
        new_hyp.apply_action(action, shuffle_fields_idx=shuffle_fields_idx)
