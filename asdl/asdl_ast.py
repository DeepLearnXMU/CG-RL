...
class AbstractSyntaxTree(object):
    def __init__(self, production, realized_fields=None, shuffle_fields_idx=None):
        ...
        self.shuffle_fields_idx = shuffle_fields_idx
        if realized_fields:
            ...
            if self.shuffle_fields_idx:
                suf_fields = [self.production.fields[i] for i in shuffle_fields_idx]
                for field in suf_fields:
    ...
    def copy(self):
        new_tree = AbstractSyntaxTree(self.production, shuffle_fields_idx=self.shuffle_fields_idx)
