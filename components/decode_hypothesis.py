...
class DecodeHypothesis(Hypothesis):
    ...
    def clone_and_apply_action_info(self, action_info, shuffle_fields_idx=None):
        action = action_info.action

        new_hyp = self.clone_and_apply_action(action, shuffle_fields_idx=shuffle_fields_idx)
