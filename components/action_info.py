...
def get_action_infos(src_query, tgt_actions, force_copy=False, shuffle_fields_idx=None):
    action_infos = []
    hyp = Hypothesis()
    for t, action in enumerate(tgt_actions):
        ...
        if shuffle_fields_idx:
            hyp.apply_action(action, shuffle_fields_idx=shuffle_fields_idx[t])
        else:
